...
@Slf4j
@Component
public class WorkflowIntegrationEventPublisher {

    private final RabbitTemplate rabbitTemplate;
    private final ObjectMapper objectMapper;
    private final String workflowEventsExchange;

    public WorkflowIntegrationEventPublisher(
    ...
    private void publishEvent(Object event, String routingKey) {
        try {
            ...
            rabbitTemplate.convertAndSend(workflowEventsExchange, routingKey, payload);
            log.info("Published event to exchange '{}' with routing key '{}': {}",
                    workflowEventsExchange, routingKey, payload);
        } catch (Exception e) {
