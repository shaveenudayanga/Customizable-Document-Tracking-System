...
const EditDocument = () => {
  ...
  const mockDocumentDetails = {
    ...
    doc2: {
      ...
      description:
        "Brief for the upcoming marketing campaign, including goals, target audience, and key deliverables.",
      attachedFiles: [],
      history: [],
      auditTrail: [],
    },
    doc3: {
      ...
      description:
        "Second draft of the legal contract, updated after client feedback.",
      attachedFiles: [],
      history: [],
      auditTrail: [],
    },
    doc4: {
      ...
      description:
        "Checklist for onboarding new employees, including required documents and steps.",
      attachedFiles: [],
      history: [],
      auditTrail: [],
    },
    doc5: {
      ...
      description:
        "Budget allocation plan for fiscal year 2025, awaiting manager approval.",
      attachedFiles: [],
      history: [],
      auditTrail: [],
    },
